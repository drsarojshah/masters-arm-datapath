...
$(ObjDir)/processor_tb.c_pre.c.tb.o : processor_tb.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling processor_tb.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/processor_hls.c_pre.c.tb.o : processor_hls.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling processor_hls.c_pre.c.tb.c" $(AVE_DIR_DLOG)
