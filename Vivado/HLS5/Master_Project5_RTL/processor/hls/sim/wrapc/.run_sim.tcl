...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "processor.autotvin.dat"
	set constFileTvOut       "processor.autotvout.dat"
	set constFileHdlTvIn     "processor.autohdltvin.dat"
	set constFileHdlTvOut    "processor.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
