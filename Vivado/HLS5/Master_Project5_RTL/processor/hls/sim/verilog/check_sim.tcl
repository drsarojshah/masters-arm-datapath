...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.processor.autotvin_pc_in.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.processor.autotvout_main_memory_out.dat"
         "rtl.processor.autotvout_opcode_out.dat"
         "rtl.processor.autotvout_op_value_1_out.dat"
         "rtl.processor.autotvout_op_value_2_out.dat"
         "rtl.processor.autotvout_result_out.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
