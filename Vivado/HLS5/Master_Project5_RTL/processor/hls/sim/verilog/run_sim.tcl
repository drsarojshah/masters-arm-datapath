...
if {[file isfile processor.autotvin.dat]} {
	file delete -force processor.autotvin.dat
}

if {[file isfile processor.autotvout.dat]} {
	file delete -force processor.autotvout.dat
}
